...
<div class="container-fluid mt-2">
  ...
  <?php
  if (isset($_REQUEST['salesmaneID'])) {
    $salesmaneID = $_REQUEST['salesmaneID'];

    include('hmb/conn.php');
    $sql = "SELECT * FROM salesmane WHERE salesmaneID=$salesmaneID";
    $result = mysqli_query($conn, $sql);
    while ($row = mysqli_fetch_assoc($result)) {
      echo '<div class="alert alert-info text-center mb-3 py-2" role="alert">
              <h5 class="mb-0">اسم المندوب: ' . $row["salesmaneName"] . '</h5>
            </div>';
    }
  } else {
...
<input type="text" id="salesmaneID" value="<?php echo $salesmaneID; ?>">
...
<script>
 ...
 <script src="fromStore2Salesmane/items.js"></script>
 <script src="fromStore2Salesmane/funModal.js"></script>
